...
function MainHeroSectionText() {
  return (
    <div className="flex flex-col min-h-5/6 justify-center">
      <h1 className="h1 mb-5 mt-auto ">
        Nooreddin <br /> <span className="italic">Emad</span>
      </h1>
      <hr className="w-30"/>
      <p className="mt-10">
      ...
      <div className="flex gap-3 mt-5">
        ...
        <DownloadLink title="My Resume" className="text-sm" Icon={Download} href="/resume/Nooreddin-Emad-CV-Front-Dev.pdf" download={true} target="_blank"  />
      </div>
      <div className="mt-auto">
      <ul className="flex gap-3">
        <li>
           <DownloadLink title="" href="" className="p-2" image={ {src:"/brands/github.svg", width:15, height:15, alt:"github"}}></DownloadLink> 
        </li>
        <li>
            <DownloadLink title="" href="" className=" p-2" image={{ src: "/brands/linkedin.svg", width: 15, height: 15, alt: "linkedin" }}></DownloadLink>
        </li>
        <li>
            <DownloadLink title="" className=" p-2" Icon={Mail} href=""  />
            <span className="sr-only">Email</span>
        </li>
            <DownloadLink title="" className=" p-2" Icon={Phone} href=""  />
